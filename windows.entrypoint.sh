#!/bin/bash
#from https://github.com/san-nat/canvas-lms/commit/dbdd4f2ac2662c82f6a9fb47d805b8495d80a75d
...
# Database population
export CANVAS_LMS_ADMIN_EMAIL=canvas@example.com && export CANVAS_LMS_ADMIN_PASSWORD=password && export CANVAS_LMS_STATS_COLLECTION=opt_out && export CANVAS_LMS_ACCOUNT_NAME=inst
